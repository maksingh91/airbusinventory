...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private void logout(HttpServletRequest request, HttpServletResponse response, Authentication authentication) { // You
																													// can
																													// process
																													// token
																													// here
	...
	void onLogoutSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication)
			throws IOException, ServletException { // this code is just sending the 200 ok response and preventing
													// redirect
